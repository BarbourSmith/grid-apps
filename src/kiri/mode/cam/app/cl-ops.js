...
export function createPopOps() {
    ...
    createPopOp('rough', {
        ...
        clear: UC.newSelect(LANG.cr_cpat_s, { title: LANG.cr_cpat_l }, "roughclear"),
        sep: UC.newBlank({ class: "pop-sep" }),
    ...
    createPopOp('helical', {
        ...
        sep:      UC.newBlank({class:"pop-sep"}),
        entry:    UC.newSelect(LANG.ch_entr_s, {title: LANG.ch_entr_l}, "helicalentry"),
        exit:     UC.newSelect(LANG.ch_exit_s, {title: LANG.ch_exit_l}, "helicalexit"),
        entryOffset: UC.newInput(LANG.ch_ento_s, {title:LANG.ch_ento_l, convert:toFloat, units:true, show:() => env.poppedRec.entry === "center" || env.poppedRec.entry === true}),
    ...
    createPopOp('area', {
        ...
        sr_slope_min: UC.newInput(LANG.ca_slmn_s, { title: LANG.ca_slmn_l, convert: toFloat, bound: UC.bound(0, 90), show: isSurface }),
        sr_slope_max: UC.newInput(LANG.ca_slmx_s, { title: LANG.ca_slmx_l, convert: toFloat, bound: UC.bound(0, 90), show: isSurface }),
