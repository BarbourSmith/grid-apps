...
self.lang['en-us'] = {
    ...
    ch_entr_s:      "enter condition",
    ch_entr_l:      ["move onto the helix path before cutting","neutral leaves the path unchanged","center enters from cylinder center","inside starts toward cylinder center","outside starts away from cylinder center"],
    ch_ento_s:      "center entry offset",
    ch_ento_l:      ["offset from path for curved center entry","usually thread depth for thread milling","in workspace units","0 for a linear center entry"],
    ch_exit_s:      "exit condition",
    ch_exit_l:      ["move off the helix path before lift","neutral leaves the path unchanged","inside moves toward cylinder center","outside moves away from cylinder center"],
    ch_rvrs_s:      "reverse",
    ch_rvrs_l:      ["reverse helical z-axis direction","low-Z to high-Z when checked","useful for thread milling","not recommended for other operations"],
    ch_clkw_s:      "clockwise",
